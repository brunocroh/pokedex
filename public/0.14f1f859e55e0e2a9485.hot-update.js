...
var pokemon = function pokemon(props) {
  ...
  var pokemonsAdded = props.state.pokemonsAdded;


  var button = pokemonsAdded.list.find(function (p) {
    return p.name === name;
  }) ? _react2.default.createElement(_Button2.default, { style: _App2.default.buttonRemove, label: 'Remover Pokemon', onClick: function onClick() {
      return pokemonRemove({ name: name, url: url });
    } }) : _react2.default.createElement(_Button2.default, { style: _App2.default.buttonAdd, label: 'Adicionar Pokemon', onClick: function onClick() {
...
//# sourceMappingURL=0.14f1f859e55e0e2a9485.hot-update.js.map